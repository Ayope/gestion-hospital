        ...
        <div class="col-10 d-flex flex-column h-100 mt-3">
            <div class="container-fluid d-inline">
                <div class="input-group d-flex justify-content-between row">
                    <div class="col-md-2 col-sm-12 order-md-1 order-1">
                    ...
                    <div class="col-md-8 col-sm-12 order-md-2 order-2">
                        <form>
                            <div class="d-flex">
                                ...
                                <div class="px-2">
                                    <button type="button" class="btn btn-primary btn-bg btn-md m-1 rounded border-0"
                                        style="
            ...
            <div class="text-center text-md-start mx-5 px-3">
                <strong>All Doctrors(1)</strong>
            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <button class="btn btn-primary btn-bg btn-md m-1 rounded "><i class="bi bi-pencil">
                                            Edit</i></button>
                                    <button class="btn btn-primary btn-bg btn-md m-1 rounded"><i class="bi bi-eye">
                                            View</i></button>
                                    <button class="btn btn-primary btn-bg btn-md m-1 rounded"><i class="bi bi-trash">
                                            Remove</i></button>
                                </div>
