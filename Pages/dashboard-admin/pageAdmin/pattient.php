...
include '../../Classes/Patient/PatientController.php';
$info = User::getById();
...
<body>
  ...
  width:100px;">
                ...
                <a class="text-decoration-none" href="dashboard.php">
                    <button type="button" id="btnDash" class=" list-group-item list-group-item-action bg-transparent second-text-color ">
                        <i class="fas fa-tachometer-alt me-2"></i>Dashboard
                    </button></a>
                <a class="text-decoration-none" href="doctors.php">

                    <button type="button" id="btnBook" class=" list-group-item list-group-item-action bg-transparent second-text-color ">
                        <i class="bi bi-heart-pulse-fill me-2"></i>Doctors
                    </button> </a>
                <a class="text-decoration-none" href="schedule.php">

                    <button type="button" id="btnprfl" class=" list-group-item list-group-item-action bg-transparent second-text-color ">
                ...
                <button type="button" id="btnprfl" class=" list-group-item list-group-item-action bg-transparent second-text-color active">
                    <i class="bi bi-bandaid-fill me-2 "></i>Patients
                </button>
                <a href="assets/backend/sessionLogOut.php" class="list-group-item list-group-item-action bg-transparent text-danger fw-bold"><i class="fas fa-power-off me-2"></i>Logout</a>
            </div>
        </div>
        <!-- /#sidebar-wrapper -->
        <!-- Page Content -->
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid px-4" id="container">
                <div id="dashboardContainer">
                    ...
                    <script src="../Classes/Patient/Patient.js"></script>
